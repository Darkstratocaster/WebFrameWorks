  ...
  render()
  {
    let output =
      <>
        ...
        <SearchView
          items={ this.state.items.filter((item) => (item.name.toLowerCase().includes(this.state.productSearchString)) || (item.band.toLowerCase().includes(this.state.productSearchString))) }
          />
